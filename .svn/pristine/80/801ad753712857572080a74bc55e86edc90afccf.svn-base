...
*/
require_once( plugin_dir_path( __FILE__ ) . '/books-panel.php' );
require_once( plugin_dir_path( __FILE__ ) . '/books-hook.php' );
require_once( plugin_dir_path( __FILE__ ) . '/books-functions.php' );
